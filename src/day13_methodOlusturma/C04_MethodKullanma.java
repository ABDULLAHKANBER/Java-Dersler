...
public class C04_MethodKullanma {
    public static void main(String[] args) {
        ...
        System.out.println(C03_Faktoryel.faktoryelHesapla(sayi1)+C03_Faktoryel.faktoryelHesapla(sayi2));

        // yada System.out.println("10'dan kucuk 2 adet pozitif tamsayi girin");
        //        int sayi1= scan.nextInt();
        //        int sayi2= scan.nextInt();
        //
